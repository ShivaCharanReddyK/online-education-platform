...
export const emailTemplates = {
  ...
  welcomeRegistration: (
    ...
    to: '', // Will be set by caller
    subject: `Welcome to LearnFlow Education Platform!`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Welcome to LearnFlow</title>
        </head>
        <body style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f5f5f5;">
          <div style="background: linear-gradient(135deg, #3F51B5, #5C6BC0); color: white; padding: 30px; text-align: center;">
            <h1 style="margin: 0; font-size: 28px; font-weight: 700;">Welcome to LearnFlow! 🎓</h1>
          </div>
          <div style="background: white; padding: 30px; margin: 0;">
            <p style="font-size: 16px; color: #333; margin-bottom: 20px;">Dear ${userName},</p>
            
            <p style="font-size: 16px; color: #333; line-height: 1.6;">
              Thank you for registering with LearnFlow! Your account has been successfully created as a <strong>${role}</strong>.
            </p>
            ...
            <div style="background: #e8f5e8; border: 2px solid #4CAF50; border-radius: 8px; padding: 20px; margin: 20px 0;">
              ...
              ${role === 'student' ? `
              <ol style="color: #333; line-height: 1.6;">
                <li>Browse our program catalog</li>
                <li>Apply to programs that interest you</li>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.APP_URL}/${role === 'student' ? 'programs' : 'counselor/dashboard'}" 
                 style="background: #3F51B5; color: white; padding: 15px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; display: inline-block; font-size: 16px;">
                Get Started
              </a>
            </div>
